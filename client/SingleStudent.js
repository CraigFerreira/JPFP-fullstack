...
class SingleStudent extends Component{
    ...
    renderStudent(){
        return(
            <div>
                {this.props.singleStudent.map((currStudent, idx)=>{
                    return( 
                        <ul className='campus' key={currStudent.firstName +currStudent.lastName+ idx}>
                            ...
                            <img className='img' src={currStudent.imgURL}/>
